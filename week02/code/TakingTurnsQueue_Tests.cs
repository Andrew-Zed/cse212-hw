...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The basic finite turns logic works when turns are positive. 
    ...
    // Defect(s) Found: None. Adding a person midway works as expected. 
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Tim (Turns = 0) is not re-enqueued beacuse the code checked `person.Turns > 1`
    ...
    // Defect(s) Found: Tim (Turns = -3) is not re-enqueued beacuse negetive turn values were treated as no turns remaining. 
    ...
    // Defect(s) Found: None. Throws InvalidOperationException correctly. 
